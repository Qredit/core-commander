...
commander_update ()
{
    ...
    if [[ "$remote_version" == "$local_version" ]]; then
        ...
        info "You already have the latest supported Qredit Commander version."
    else
        STATUS_COMMANDER_UPDATE="Yes"

        read -p "An update is available for Qredit Commander, do you want to install it? [Y/n] : " choice
